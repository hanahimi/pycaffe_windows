...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.BNParameter bn_param = 149;
  inline bool has_bn_param() const;
  inline void clear_bn_param();
  static const int kBnParamFieldNumber = 149;
  ...
  // optional .caffe.UpsampleParameter upsample_param = 150;
  inline bool has_upsample_param() const;
  inline void clear_upsample_param();
  static const int kUpsampleParamFieldNumber = 150;
...
class DropoutParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional bool sample_weights_test = 2 [default = false];
  inline bool has_sample_weights_test() const;
  inline void clear_sample_weights_test();
  static const int kSampleWeightsTestFieldNumber = 2;
  inline bool sample_weights_test() const;
  inline void set_sample_weights_test(bool value);
 ...
 private:
  ...
  inline void set_has_sample_weights_test();
  inline void clear_has_sample_weights_test();
...
// optional bool sample_weights_test = 2 [default = false];
inline bool DropoutParameter::has_sample_weights_test() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void DropoutParameter::set_has_sample_weights_test() {
  _has_bits_[0] |= 0x00000002u;
}
inline void DropoutParameter::clear_has_sample_weights_test() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void DropoutParameter::clear_sample_weights_test() {
  sample_weights_test_ = false;
  clear_has_sample_weights_test();
}
inline bool DropoutParameter::sample_weights_test() const {
  // @@protoc_insertion_point(field_get:caffe.DropoutParameter.sample_weights_test)
  return sample_weights_test_;
}
inline void DropoutParameter::set_sample_weights_test(bool value) {
  set_has_sample_weights_test();
  sample_weights_test_ = value;
  // @@protoc_insertion_point(field_set:caffe.DropoutParameter.sample_weights_test)
}
